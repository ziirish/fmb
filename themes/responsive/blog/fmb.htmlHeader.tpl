...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    <head>
        ...
        <meta property="og:title" content="FMB blog" />
	...
	<!-- RSS Feeds -->
	<link rel="alternate" type="application/rss+xml" title="RSS Feed of posts" href="{$fmbBlogUrl}feed.xml" />
	<link rel="alternate" type="application/rss+xml" title="RSS Feed of comments" href="{$fmbBlogUrl}feed.xml?style=comments" />
	<link rel="alternate" type="application/rss+xml" title="Full RSS Feed of posts (caution, this feed is quite big)" href="{$fmbBlogUrl}feed.xml?full" />
        <!-- Template's style -->
...
{/if}
        ...
        <!--[if lt IE 9]>
            <script type="text/javascript" src="{$fmbTemplatesUrl}{$fmbStyle}/blog/js/inc/html5shiv.js"></script>
